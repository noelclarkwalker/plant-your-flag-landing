(function () {
  ...
  function hideBruno() {
    ...
    duo.classList.remove("is-discovered", "is-animating");
  }

  function toggleBruno() {
    if (BRUNO.duo && BRUNO.duo.classList.contains("is-discovered")) {
      hideBruno();
      return;
    }
